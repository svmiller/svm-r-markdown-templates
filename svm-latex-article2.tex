...
% $if(sansitup)$\sffamily$else$$endif$
\titleformat*{\section}{\normalsize\bfseries}
...
$else$
$if(anonymous)$\hfill $else$$for(author)$\MakeUppercase{$author.name$}, \emph{\small $author.affiliation$}  $sep$ \par \vskip -5.5pt $endfor$ $endif$
$endif$
